...
const BASE_TEMPLATES: Record<SystemCategory, string[]> = {
  ...
  rental: [
    'Hire it, ride it, enjoy it',
    'Easy rentals, great rates',
    'Get going in minutes',
    'Quality kit, ready when you are',
    'Your local hire spot',
  ],
  automotive: [
    'Keeping you on the road',
    'Trusted local mechanics',
    'Quality service, fair prices',
    'Your car, in safe hands',
    'Repairs done right',
  ],
  health: [
  ...
  grocery: [
    'Fresh produce, friendly service',
    'Your local food stop',
    'Everyday essentials, quality finds',
    'Fresh, local, and convenient',
    'Stock up the easy way',
  ],
  other: [
