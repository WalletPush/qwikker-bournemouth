...
export const SUITE_TEMPLATES: SuiteTemplateDef[] = [
  ...
  },
  {
    ...
    requiresMarketingUnsub: false,
    mergeFields: ['business_name', 'first_name', 'missing_items'],
    visibleInSuite: true,
    campaignAllowed: true,
  ...
  },
  {
    ...
    requiresMarketingUnsub: false,
    mergeFields: ['business_name', 'first_name'],
  ...
  },
  {
    ...
    requiresMarketingUnsub: true,
    mergeFields: ['business_name', 'first_name', 'offers'],
    visibleInSuite: true,
    campaignAllowed: true,
  ...
  },
  {
    ...
    requiresMarketingUnsub: false,
    mergeFields: ['business_name', 'first_name', 'trial_days'],
    visibleInSuite: true,
    campaignAllowed: true,
  ...
  },
  {
    ...
    requiresMarketingUnsub: false,
    mergeFields: ['business_name', 'first_name', 'loyalty_url'],
    visibleInSuite: false,
    campaignAllowed: false,
    recommendedAudiences: ['business_ids'],
  },
  {
    ...
    requiresMarketingUnsub: true,
    mergeFields: ['business_name', 'first_name', 'stats'],
    visibleInSuite: false,
    campaignAllowed: false,
  ...
  },
  {
    ...
    requiresMarketingUnsub: true,
    mergeFields: ['business_name', 'first_name', 'body'],
    visibleInSuite: true,
    campaignAllowed: true,
