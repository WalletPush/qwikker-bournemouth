...
function middleware(request) {
    // 🎯 Allow public access to user dashboard for demos
    if (request.nextUrl.pathname.startsWith('/user')) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$3_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next();
    }
    // Check for auth token in cookies (simple approach)
    const authToken = request.cookies.get('sb-access-token') || request.cookies.get('sb-iiiciapavjonpmldytxf-auth-token');
