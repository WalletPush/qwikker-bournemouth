...
type AppRouteHandlerRoutes = "/api/admin/analytics" | "/api/admin/approve" | "/api/admin/approve-business" | "/api/admin/approve-change" | "/api/admin/contacts" | "/api/admin/contacts/bulk-sync-ghl" | "/api/admin/contacts/simple-update" | "/api/admin/contacts/sync-ghl" | "/api/admin/contacts/update" | "/api/admin/franchise" | "/api/admin/login" | "/api/admin/logout" | "/api/admin/sync/bulk-sync" | "/api/admin/sync/force-sync" | "/api/admin/sync/health" | "/api/admin/update-notes" | "/api/check-pass-ready" | "/api/dashboard/ai-support" | "/api/franchise/crm-sync" | "/api/ghl-webhook/offer-update" | "/api/ghl-webhook/user-creation" | "/api/push/send" | "/api/push/subscribe" | "/api/push/unsubscribe" | "/api/qr/track" | "/api/test-contact-update" | "/api/verify-wallet-pass" | "/api/wallet/create-offer-pass" | "/api/wallet/update-existing-passes" | "/api/walletpass/create-main-pass" | "/api/walletpass/update-main-pass" | "/api/walletpass/user-creation" | "/auth/confirm" | "/auth/logout"
