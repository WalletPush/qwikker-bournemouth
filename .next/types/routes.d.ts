...
type AppRoutes = "/" | "/admin" | "/admin/ai-test" | "/admin/debug" | "/admin/franchise-setup" | "/admin/login" | "/admin/monitoring" | "/admin/utils/cleanup-auth" | "/admin/utils/create-test-profile" | "/admin/utils/debug-users" | "/admin/utils/delete-orphaned-users" | "/admin/utils/init-mock-user" | "/admin/utils/reset-david" | "/admin/wallet-pass-update" | "/auth/error" | "/auth/forgot-password" | "/auth/login" | "/auth/sign-up" | "/auth/sign-up-success" | "/auth/update-password" | "/business" | "/business/dashboard" | "/coming-soon" | "/dashboard" | "/dashboard/action-items" | "/dashboard/analytics" | "/dashboard/business" | "/dashboard/files" | "/dashboard/loyalty" | "/dashboard/notifications" | "/dashboard/offers" | "/dashboard/personal" | "/dashboard/profile" | "/dashboard/referrals" | "/dashboard/secret-menu" | "/dashboard/settings" | "/dashboard/support" | "/debug-supabase" | "/embed/chat" | "/intent" | "/intent/[...params]" | "/intent/[code]" | "/offline" | "/onboarding" | "/onboarding/success" | "/phase2-gate" | "/protected" | "/simulate-wallet-pass" | "/test-ai" | "/test-qr-scroll" | "/user" | "/user/badges" | "/user/business/[slug]" | "/user/chat" | "/user/dashboard" | "/user/discover" | "/user/how-it-works" | "/user/offers" | "/user/secret-menu" | "/user/settings" | "/verify-pass" | "/waiting-for-pass" | "/wallet-pass/[id]" | "/welcome"
type AppRouteHandlerRoutes = "/api/admin/analytics" | "/api/admin/approve" | "/api/admin/approve-business" | "/api/admin/approve-change" | "/api/admin/contacts" | "/api/admin/contacts/bulk-sync-ghl" | "/api/admin/contacts/simple-update" | "/api/admin/contacts/sync-ghl" | "/api/admin/contacts/update" | "/api/admin/franchise" | "/api/admin/login" | "/api/admin/logout" | "/api/admin/sync/bulk-sync" | "/api/admin/sync/force-sync" | "/api/admin/sync/health" | "/api/admin/update-notes" | "/api/check-pass-ready" | "/api/dashboard/ai-support" | "/api/franchise/crm-sync" | "/api/ghl-webhook/offer-update" | "/api/ghl-webhook/user-creation" | "/api/ghl-webhook/user-creation-simple" | "/api/push/send" | "/api/push/subscribe" | "/api/push/unsubscribe" | "/api/qr/track" | "/api/test-contact-update" | "/api/verify-wallet-pass" | "/api/wallet/create-offer-pass" | "/api/wallet/update-existing-passes" | "/api/walletpass/create-main-pass" | "/api/walletpass/update-main-pass" | "/api/walletpass/user-creation" | "/auth/confirm" | "/auth/logout"
