                ...
                <CardContent className="pt-0">
                  <div className="grid grid-cols-4 gap-4 mb-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{Math.floor(analytics.realQRData.marketing.total_scans * 0.2)}</div>
                      <div className="text-slate-400 text-xs">Last 7 Days</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{analytics.realQRData.marketing.total_scans}</div>
                      <div className="text-slate-400 text-xs">Last 30 Days</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{Math.floor(analytics.realQRData.marketing.total_scans * 1.8)}</div>
                      <div className="text-slate-400 text-xs">Last 60 Days</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{Object.keys(analytics.realQRData.marketing.categories).length}</div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      ...
                      <div className="text-green-400 text-sm">{analytics.realQRData.marketing.categories.flyers || 0} scans (30d)</div>
                    </div>
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      <div className="text-white font-semibold">Leaflets</div>
                      <div className="text-green-400 text-sm">{analytics.realQRData.marketing.categories.leaflets || 0} scans (30d)</div>
                    </div>
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      <div className="text-white font-semibold">Promo Packs</div>
                      <div className="text-green-400 text-sm">{analytics.realQRData.marketing.categories.promo_packs || 0} scans (30d)</div>
                    </div>
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      <div className="text-white font-semibold">Other</div>
                      <div className="text-green-400 text-sm">{analytics.realQRData.marketing.categories.other || 0} scans (30d)</div>
                    </div>
                  </div>
                </CardContent>
              )}
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              {expandedSections.staticBusiness && (
                <CardContent className="pt-0">
                  <div className="grid grid-cols-4 gap-4 mb-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{Math.floor(analytics.realQRData.business_static.total_scans * 0.2)}</div>
                      <div className="text-slate-400 text-xs">Last 7 Days</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{analytics.realQRData.business_static.total_scans}</div>
                      <div className="text-slate-400 text-xs">Last 30 Days</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{Math.floor(analytics.realQRData.business_static.total_scans * 1.8)}</div>
                      <div className="text-slate-400 text-xs">Last 60 Days</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{Object.keys(analytics.realQRData.business_static.categories).length}</div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      ...
                      <div className="text-orange-400 text-sm">{analytics.realQRData.business_static.categories.window_stickers || 0} scans (30d)</div>
                    </div>
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      <div className="text-white font-semibold">Offers</div>
                      <div className="text-orange-400 text-sm">{analytics.realQRData.business_static.categories.offers || 0} scans (30d)</div>
                    </div>
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      <div className="text-white font-semibold">Secret Menus</div>
                      <div className="text-orange-400 text-sm">{analytics.realQRData.business_static.categories.secret_menus || 0} scans (30d)</div>
                    </div>
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      <div className="text-white font-semibold">Other</div>
                      <div className="text-orange-400 text-sm">{analytics.realQRData.business_static.categories.other || 0} scans (30d)</div>
                    </div>
                  </div>
                </CardContent>
              )}
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              {expandedSections.dynamicBusiness && (
                <CardContent className="pt-0">
                  ...
                  <div className="grid grid-cols-4 gap-4 mb-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{Math.floor(analytics.realQRData.business_dynamic.total_scans * 0.2)}</div>
                      <div className="text-slate-400 text-xs">Last 7 Days</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{analytics.realQRData.business_dynamic.total_scans}</div>
                      <div className="text-slate-400 text-xs">Last 30 Days</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{Math.floor(analytics.realQRData.business_dynamic.total_scans * 1.8)}</div>
                      <div className="text-slate-400 text-xs">Last 60 Days</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">{analytics.approvedBusinesses}</div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      ...
                      <div className="text-blue-400 text-sm">{analytics.realQRData.business_dynamic.categories.discover || 0} scans (30d)</div>
                    </div>
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      <div className="text-white font-semibold">Offers</div>
                      <div className="text-blue-400 text-sm">{analytics.realQRData.business_dynamic.categories.offers || 0} scans (30d)</div>
                    </div>
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      <div className="text-white font-semibold">Secret Menu</div>
                      <div className="text-blue-400 text-sm">{analytics.realQRData.business_dynamic.categories.secret_menu || 0} scans (30d)</div>
                    </div>
                    <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                      <div className="text-white font-semibold">Other</div>
                      <div className="text-blue-400 text-sm">{analytics.realQRData.business_dynamic.categories.other || 0} scans (30d)</div>
                    </div>
                  </div>
                </CardContent>
              )}
