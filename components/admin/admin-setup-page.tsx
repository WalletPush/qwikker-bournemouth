...
export function AdminSetupPage({ city }: AdminSetupPageProps) {
  ...
  // Check URL params for Stripe callback results (legacy, in case of old bookmarks)
  useEffect(() => {
              ...
              <CardContent className="space-y-8">
                ...
                <div className="border-2 border-slate-700/50 rounded-xl p-6 hover:border-slate-600 transition-colors bg-slate-800/30">
                  ...
                  <div>
                    ...
                    {config.has_openai_api_key && config.openai_api_key?.includes('••••') ? (
                      // Key exists but is masked - show configured state
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 px-4 py-2.5 bg-slate-700/50 border border-slate-600 rounded-lg">
                          ...
                          <span className="text-xs text-slate-400 ml-auto">API key configured</span>
                        </div>
                        <button
                          type="button"
                          onClick={() => setConfig({...config, openai_api_key: '', has_openai_api_key: false})}
                      ...
                      // No key or unmasked key - show input
                      <div className="relative">
                        <Input
                ...
                <div className="border-2 border-slate-700/50 rounded-xl p-6 hover:border-slate-600 transition-colors bg-slate-800/30">
                  ...
                  <div>
                    ...
                    {config.has_anthropic_api_key && config.anthropic_api_key?.includes('••••') ? (
                      ...
                      <div className="space-y-2">
                        ...
                        <button
                          type="button"
                          onClick={() => setConfig({...config, anthropic_api_key: '', has_anthropic_api_key: false})}
                          className="text-sm text-blue-400 hover:text-blue-300 transition-colors"
                        >
                          Replace key →
                        </button>
                ...
                <div className="border-2 border-slate-700/50 rounded-xl p-6 hover:border-slate-600 transition-colors bg-slate-800/30">
                  ...
                  <div>
                    ...
                    {config.has_google_places_api_key && config.google_places_api_key?.includes('••••') ? (
                      // Key exists but is masked
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 px-4 py-2.5 bg-slate-700/50 border border-slate-600 rounded-lg">
                          <svg className="w-4 h-4 text-[#00D083]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-6">
            <Card className="bg-gradient-to-br from-slate-800/90 to-slate-900/90 border-2 border-green-500/50 shadow-2xl backdrop-blur-sm">
              ...
              <CardContent className="space-y-8">
                ...
                {/* Stripe Connect - Moved to Pricing & Billing tab */}
                <div className="border-2 border-slate-700/50 rounded-xl p-6 bg-slate-800/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-slate-400 text-sm">Connect Stripe after launching your city — head to the <span className="text-[#00D083] font-medium">Pricing & Billing</span> tab</p>
                    </div>
                  </div>
                </div>
