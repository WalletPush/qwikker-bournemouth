...
export function AdminDashboardOverview({ 
  ...
  return (
    <div className="space-y-8">
      ...
      {/* WalletPush Analytics */}
      <div>
        <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-2">
          <svg className="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
          </svg>
          Wallet Pass Analytics ({city.charAt(0).toUpperCase() + city.slice(1)})
        </h2>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="p-4 bg-slate-800/50 border border-slate-700/50">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-400">Offers Claimed</p>
                <p className="text-2xl font-bold text-white">{walletAnalytics.offersClaimed}</p>
              </div>
          ...
          <Card className="p-4 bg-slate-800/50 border border-slate-700/50">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-400">Offers Redeemed</p>
                <p className="text-2xl font-bold text-white">{walletAnalytics.offersRedeemed}</p>
              </div>
