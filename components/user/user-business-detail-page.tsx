            ...
            <>
              ...
              <div className="absolute top-3 right-3 z-20 flex flex-col gap-1 items-end">
                ...
                <a
                  ...
                  className="px-1.5 py-0.5 rounded text-[9px] leading-tight whitespace-nowrap bg-[#00d083]/20 hover:bg-[#00d083]/30 backdrop-blur-sm border border-[#00d083]/40 hover:border-[#00d083]/60 text-[#00d083] transition-colors"
                >
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-3">
                    ...
                    {business.vibe_tags && (
                      (() => {
                        const vt = business.vibe_tags as { selected?: string[]; custom?: string[] }
                        const allTags = [...(vt.selected || []), ...(vt.custom || [])]
                        if (allTags.length === 0) return null
                        return (
                          <div className="flex items-start gap-3">
                            <svg className="w-5 h-5 text-[#00d083] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                            </svg>
                            <div>
                              <p className="text-slate-100 font-medium mb-1">Vibes</p>
                              <div className="flex flex-wrap gap-1.5">
                                {allTags.map((tag: string) => (
                                  <span
                                    key={tag}
                                    className="bg-slate-700/50 border border-slate-600 text-slate-300 text-xs px-2.5 py-1 rounded-full"
                                  >
