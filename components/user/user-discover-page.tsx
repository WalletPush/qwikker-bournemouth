    ...
    <div className="space-y-6">
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-3 bg-slate-800/60 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-[#00d083]/40 focus:border-[#00d083]/40 transition-colors text-sm"
        />
        {searchQuery && (
          <button
