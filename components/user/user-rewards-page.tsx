  ...
  if (memberships.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
        <div className="w-16 h-16 rounded-full bg-zinc-800/80 border border-zinc-700 flex items-center justify-center mb-4">
          <Trophy className="w-7 h-7 text-zinc-600" />
        </div>
        <p className="text-white font-semibold text-lg mb-1">No loyalty cards yet</p>
        <p className="text-zinc-500 text-sm max-w-xs">
          Discover businesses with loyalty programs and start earning rewards.
        </p>
        <Link
          href="/user/discover"
