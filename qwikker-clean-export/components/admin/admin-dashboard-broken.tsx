...
// Removed AdminAIChat import - now using redirect approach
...
export function AdminDashboard({ businesses, crmData, adminEmail, city, cityDisplayName, pendingChangesCount, pendingChanges }: AdminDashboardProps) {
  ...
  const updateActiveTab = (newTab: 'pending' | 'updates' | 'live' | 'incomplete' | 'rejected' | 'knowledge' | 'analytics' | 'contacts' | 'ai-test' | 'qr-codes') => {
    setActiveTab(newTab)
