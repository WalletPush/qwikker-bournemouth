-- Migration: Create business_changes table for tracking pending business updates
-- Description: Allows businesses to submit changes (offers, secret menu, images) that require admin approval
-- Date: 2025-09-20 12:00:00 UTC

-- Create business_changes table
