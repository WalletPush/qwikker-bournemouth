...
-- ============================================================================
-- This function ensures business approval and trial creation happen together.
-- NO business should have business_tier='free_trial' without a subscription row.
...
BEGIN
  ...
  WHERE id = p_business_id
    AND status != 'approved'; -- Only if not already approved
  ...
  ON CONFLICT (business_id) DO NOTHING; -- Don't overwrite existing subscription
