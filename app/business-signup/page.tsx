...
export default async function BusinessSignupPage() {
  ...
  try {
    currentCity = await getCityFromRequest(headersList)
    cityDisplayName = getCityDisplayName(currentCity)
  } catch (error) {
    // Invalid city or no city detected - show error
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
        <div className="text-center text-white max-w-md">
          <h1 className="text-3xl font-bold mb-4">City Not Found</h1>
          <p className="text-slate-400 mb-8">
            This page must be accessed from a city subdomain.
          </p>
          <a 
            href="/for-business"
            className="inline-block bg-[#00d083] hover:bg-[#00b86f] text-black font-bold py-3 px-8 rounded-xl transition-colors"
          >
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            {/* City Name */}
            <div className="mb-12">
              <p className="text-2xl text-[#00d083] font-semibold">
                {cityDisplayName}
              </p>
            </div>
